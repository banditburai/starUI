    ...
    def color_picker_popover_example():
        return Div(
            ...
            Div(
                ...
                Div(
                    P("This text uses your selected color", ds_style(color="$selected_color"), cls="font-medium"),
                    Div(ds_style(background_color="$selected_color"), cls="w-full h-16 rounded border mt-2")
                ),
