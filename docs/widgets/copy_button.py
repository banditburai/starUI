...
def CopyButton(
    ...
    variants = {
        "embedded": "h-5 w-5 p-0 text-muted-foreground transition-all duration-200 hover:bg-muted hover:text-foreground",
        ...
        "inline": "ml-3 h-6 w-6 flex-shrink-0 p-0 text-muted-foreground transition-colors hover:text-foreground",
    }
