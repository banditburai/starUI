...
from src.starui.registry.components.avatar import Avatar, AvatarImage, AvatarFallback
...
def test_command():
    return Page(
        ...
        Command(
            ...
            CommandList(
                ...
                CommandGroup(
                    CommandItem(
                        Div(
                            Icon("lucide:file", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                    ...
                    CommandItem(
                        Div(
                            Icon("lucide:folder", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                            style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                        ),
                    ...
                    CommandItem(
                        Div(
                            Icon("lucide:save", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                            style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                        ),
                        Span("Save", cls="ml-2"),
                        CommandShortcut("⌘S"),
                ...
                CommandGroup(
                    CommandItem(
                        Div(
                            Icon("lucide:settings", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                            style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                        ),
                    ...
                    CommandItem(
                        Div(
                            Icon("lucide:user", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                            style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                        ),
                    ...
                    CommandItem(
                        Div(
                            Icon("lucide:log-out", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                            style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                        ),
        ...
        CommandDialog(
            trigger=Button(
                Div(
                    Icon("lucide:terminal", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                    style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                ),
            ...
            content=[
                ...
                CommandList(
                    ...
                    CommandGroup(
                        CommandItem(
                            Div(
                                Icon("lucide:copy", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                                style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                            ),
                            Span("Copy", cls="ml-2"),
                            CommandShortcut("⌘C"),
                        ...
                        CommandItem(
                            Div(
                                Icon("lucide:clipboard", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                                style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                            ),
                            Span("Paste", cls="ml-2"),
                            CommandShortcut("⌘V"),
                        ...
                        CommandItem(
                            Div(
                                Icon("lucide:scissors", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                                style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                            ),
                            Span("Cut", cls="ml-2"),
                            CommandShortcut("⌘X"),
                    ...
                    CommandGroup(
                        CommandItem(
                            Div(
                                Icon("lucide:layout", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                                style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                            ),
                        ...
                        CommandItem(
                            Div(
                                Icon("lucide:moon", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                                style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                            ),
                    ...
                    CommandGroup(
                        CommandItem(
                            Div(
                                Icon("lucide:help-circle", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                                style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                            ),
                            Span("Help", cls="ml-2"),
                            CommandShortcut("⌘?"),
                        ...
                        CommandItem(
                            Div(
                                Icon("lucide:keyboard", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                                style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                            ),
        ...
        Command(
            ...
            CommandList(
                ...
                CommandItem(
                    Div(
                        Icon("lucide:check", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                        style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                    ),
                ...
                CommandItem(
                    Div(
                        Icon("lucide:lock", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                        style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                    ),
                ...
                CommandItem(
                    Div(
                        Icon("lucide:shield", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                        style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                    ),
                ...
                CommandItem(
                    Div(
                        Icon("lucide:play", width="16", height="16", style="display: block; width: 100%; height: 100%;"),
                        style="display: inline-block; width: 16px; height: 16px; flex-shrink: 0; overflow: hidden;"
                    ),
