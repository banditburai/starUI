...
button_variants = cva(
    base=(
        ...
        "aria-invalid:border-destructive [&_iconify-icon]:shrink-0"
    ),
    config={
        "variants": {
            "variant": {
                ...
                "outline": "border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border dark:hover:bg-input/50",
